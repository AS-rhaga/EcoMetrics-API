...
from Util.VesselMaster import VesselMaster
from Util.FuelOilType import FuelOilType
from Util import Util

def util_EmissionBoard_Unit(imo, Timestamp_from, Timestamp_to, response, Unit, VESSELMASTER, FUELOILTYPE, unit_timestamp_list):
    ...
    for index in range(len(unit_timestamp_list)):
        ...
        if unit_timestamp_exist == True:
            ...
            AverageUnit.append(AverageInfo)
    ...
    print(f"AverageUnit: {AverageUnit}")    
    ...
    RESPONSE["AverageUnit"] = AverageUnit
        
    return RESPONSE
            

    
def util_EmissionBoard_main(imo, Timestamp_from, Timestamp_to, response, unit_timestamp_list, Unit):
    ...
    print(f"VESSELMASTER: {VESSELMASTER}, FUELOILTYPE: {FUELOILTYPE}")
    
    EmissionBoard = {}
    if len(response):
        # 集計単位のタイプ毎に、必要項目の集計結果を取得
        RESPONSE = util_EmissionBoard_Unit(imo, Timestamp_from, Timestamp_to, response, Unit, VESSELMASTER, FUELOILTYPE, unit_timestamp_list)
        ...
        EmissionBoard = {
            ...
            "AverageUnit"                       : RESPONSE["AverageUnit"]
        }
    else:
        EmissionBoard = {
            "VESSELMASTER": VESSELMASTER,
